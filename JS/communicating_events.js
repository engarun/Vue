<script>
    ...
    Vue.component('product', {
        ...
        template: `
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                            <button v-if="inStock" @click="cartTotal" class="btn-success">AddToCart</button>
                            <button v-else class="text-secondary" disabled="true">OutOfStcok</button>
                            <button class="btn-danger" @click="removeFromCart">Remove From Cart</button>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col">
                            <p class="small text-primary">Move over the color boxes, the details of the product will change respectively.
                             If stock is 0 then the addToCart button will be disabled and change the color of the button to gray and label as OutOfStcok</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
        ...
        methods: {
            ...
            cartTotal() {
                this.$emit('add-to-cart', this.products[this.selectedProduct].id)
            },
            removeFromCart() {
                this.$emit('remove-from-cart', this.products[this.selectedProduct].id)
            }
        },
        computed: {
            storeInfo() {
